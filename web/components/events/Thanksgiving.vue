        ...
        <div class="relative flex space-x-3">
          <div>
            <span class="h-8 w-8 rounded-full bg-gray-400 flex items-center justify-center ring-8 ring-white">
              <Lottie ref="thanksgiving" :lottie-settings="lottieSettings" />
            </span>
          </div>
...
export default Vue.extend({
  ...
  data () {
    return {
      // lottieSettings: { path: '/json/turkey-bird.json', class: 'h-8 w-8' },
      lottieSettings: { path: '/json/56305-cool-turkey.json', class: 'h-8 w-8' },
    }
  },
})
</script>
