          ...
          <div class="relative">
            <div class="sm:text-center">
              <p class="text-3xl font-extrabold text-white tracking-tight sm:text-4xl">
                Powered by
                <svg class="inline" width="120" height="39" fill="#19AE82" xmlns="http://www.w3.org/2000/svg">
              ...
              <div>
                <div class="mt-6 mx-auto max-w-2xl text-lg text-indigo-200">
                  This version of ChaseApp is supported by <a href="https://nodle.com">Nodle</A>. Your smartphones Bluetooth
                  connection and Location services are used while you're browsing ChaseApp to enable a crowdsourced IoT network.
                  There is no personal data captured, and it uses very low bandwidth. We earn a small fee for this that helps
                  cover our costs and you see no advertisements and pay nothing.
                  <br>
                  <br>
                  There are millions of these IoT devices everywhere, and they need to send small messages periodically;
                  devices like your gas meter, Apple tags, E-Bikes, and there will be billions more. Nodle briefly turns
                  your smart phone into a hotspot for these IoT-enabled devices.
                </div>
              </div>
            </div>
          </div>
